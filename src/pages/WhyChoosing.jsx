...
function WhyChoosing() {
  const style = "tracking-tighter"
  const lineStyle = "translate-y-4"
  const featureList = [
    {
  ...
  return (
    <div className='bg-thirdColor py-28 w-full'>
      <div className='bg-white max-w-screen-2xl mx-auto px-12 md:px-24 lg:px-44 overflow-x-hidden'>
        <Title lineStyle={lineStyle} style={style}>what makes us <span className='bg-gradient-to-r from-gradientStart to-gradientEnd text-transparent bg-clip-text font-extrabold tracking-wider'>different</span></Title>
        <div>
