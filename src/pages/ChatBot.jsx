  ...
  return (
    <div>
      <div className="fixed z-50 left-0 top-1/3">
        ...
        {
          userWannaAsk && (
            <form className="flex flex-col items-center gap-2 border-4 border-white outline outline-green bg-lightOrange p-6" onSubmit={(e) => {handleAnswer(e)}}>
              <p className="font-bold text-darkblue ">Hello, Welcome Genius Coders ChatBot😅</p>
              <p className="font-bold text-darkblue ">الطفل كام سنة ؟</p>
              <input onChange={(e) => setUserAge(e.target.value)} value={userAge} className="focus:outline-green border rounded w-full p-4 placeholder:capitalize" placeholder="write your answer" type="text" /> 
