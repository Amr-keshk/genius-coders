...
import flyAstronaut from "/elements/fly-astronaut.png"
      ...
      <div className='w-full py-28 relative overflow-hidden'>
        ...
        <div className='container max-w-screen-2xl mx-auto px-4 sm:px-12 md:px-24 lg:px-44 bg-white relative'>
          ...
          <div className='flex flex-col gap-6 items-center lg:flex-row lg:items-start'>
            ...
            <InfoSection 
              paragraph={paragraph} 
              subTitle={<>it&apos;s our passion to work with children at <span className='text-orange uppercase'>Genius Coders</span></>} 
              title='about us' 
              iconStyle="fa-regular fa-circle-check bg-green w-4 h-4 rounded-full text-white" 
              linkStyle={linkStyle} 
              titleIcon={titleIcon} 
              featureList={featureList} 
              linkChild="learn from experts" 
            />
          </div>
        </div>

        <img className="flying-dinosour -scale-x-100 absolute -bottom-0 right-0" src={flyAstronaut} alt="flying Astronaut illustration" />
