  ...
  return (
    <section className='w-full py-28'>
      <div className='bg-white max-w-screen-2xl mx-auto px-12 md:px-24 lg:px-44 overflow-x-hidden'>
        ...
        <div className='relative flex flex-col gap-6 items-center lg:flex-row lg:items-start'>
          <div className='flex-1 flex items-end justify-center gap-4'>
            <div className="relative">
              <p className="w-4 h-4 inline-block bg-red-500 rounded-full"></p>
            ...
            <div className="relative">
              <p className="ml-auto w-8 h-8 bg-orange rounded-full"></p>
              ...
              <p className="mx-auto mt-6 w-6 h-6 bg-green rounded-full"></p>
            </div>
          </div>
          ...
          <div className='flex-1 text-darkblue text-center lg:text-start'>
            <Title iconTitle = {iconTitle}>about us</Title>
