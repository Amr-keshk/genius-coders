...
function Hero() {
  return (
    <div className='overflow-y-scroll'>
      ...
      <div className='flex flex-col lg:flex-row lg:items-center w-full h-screen pt-28 px-8 sm:px-12 md:px-24 relative overflow-hidden'>
          ...
          <div className='text-secondaryColor font-bold capitalize'>
            ...
            <button>
              <Link to="/contact" className='relative'>
                <span className='uppercase bg-primaryColor my-4 p-3 hover:bg-secondaryColor rounded-e-full hover:text-primaryColor transition-all duration-500'>start for free</span>
