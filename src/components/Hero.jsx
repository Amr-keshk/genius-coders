  ...
  return (
    <div className='flex flex-col lg:flex-row lg:items-center w-full h-screen pt-[90px] px-8 sm:px-12 md:px-24 relative overflow-hidden'>
      ...
      <div className='flex-1 lg:flex-initial lg:w-4/6 xl:flex-1 flex justify-center flex-col'>
        ...
        <h1 className="text-primaryTextColor text-2xl font-bold uppercase">today, learning <strong className='text-primaryColor'>programming</strong> is essential, <span className='block'>not optional</span></h1>
        <ul className='text-primaryTextColor sm:my-8 text-2xl'>
        ...
        <div className='text-secondaryColor font-bold capitalize'>
          ...
          <button>
            <Link to="/contact" className='relative'>
              <span className='uppercase bg-primaryColor p-2 my-4 sm:p-4 hover:bg-secondaryColor rounded-e-full hover:text-primaryColor transition-all duration-500'>Get Started</span>
