...
const infoList = [
  {icon: location, title: "address:", info: "Egypt-Cairo"},
  {icon: phone, title: "phone:", info: "(+20) 010-288-15-414"},
  {icon: mail, title: "email", info: "akeshk69@gmail.com"},
]
    ...
    <div className='bg-black'>
      <div className='max-w-screen-2xl mx-auto px-12 md:px-24 lg:px-44 overflow-x-hidden'>
        <div className='text-white font-bold grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3'>
          {infoList.map(info => 
            <div className='border-gray p-4 py-6 flex gap-4 border-b sm:even:border-l md:even:border-x ' key={info.title}>
              <span className='inline-block fill-gray rounded-full border-2 border-gray p-2'>{info.icon}</span>
              <div>
        ...
        <div className='text-gray pt-10'>

          <div >
            <img className='h-16' src={logo} alt="" />
            <p className='text-gray'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, incidunt perferendis recusandae aliquid assumenda porro quae doloribus nihil ea molestiae cumque corporis repellat iste minima error temporibus iusto reiciendis vel soluta quos voluptatem ullam quis! Fugit officia assumenda quibusdam, corporis iure odio eos reprehenderit nulla sapiente? Quidem velit id soluta.</p>
            <SocialList socialIconStyle={socialIconStyle}/>
